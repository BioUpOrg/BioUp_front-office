...
return (
    <div style={{ display: 'flex', justifyContent: 'center', paddingBottom:'200px' , paddingTop:'100px' }}>
      <Box sx={{ flexGrow: 1 }}>
        <Paper variant="outlined" square>
          <h1 style={{ display: 'flex', justifyContent: 'center' , paddingBottom:'20px' , paddingTop:'20px' , color:"green" }} >All My Farms</h1>
